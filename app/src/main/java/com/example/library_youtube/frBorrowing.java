 ...
 * Use the {@link frBorrowing#newInstance} factory method to
 * create an instance of this fragment.
 */
public class frBorrowing extends Fragment {
     ...
     * @return A new instance of fragment frBorrowing.
     */
    // TODO: Rename and change types and number of parameters
    public static frBorrowing newInstance(String param1, String param2) {
        frBorrowing fragment = new frBorrowing();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_fr_borrowing, container, false);
        ...
        database.getReference().child("notes").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                NoteAdapter adapter = new NoteAdapter(getContext(), arrayList);
